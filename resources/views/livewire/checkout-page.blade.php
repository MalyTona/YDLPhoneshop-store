            ...
            <div class="md:col-span-12 lg:col-span-8 col-span-12">
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input wire:model='first_name' @error('first_name') border-red-500 @enderror class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" id="first_name" name="first_name" type="text">
                                @error('first_name')
                            ...
                            <div>
                                ...
                                <input wire:model='last_name' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" id="last_name" name="last_name" type="text">
                                @error('last_name')
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model='phone' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" id="phone" name="phone" type="tel">
                            @error('phone')
                            <div class="text-red-500 dark:text-red-400 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <select wire:model='province' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-gray-200 dark:border-none @error('province') border-red-500 @enderror" id="province" name="province">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea wire:model="street_address" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-gray-200 dark:border-none @error('street_address') border-red-500 @enderror" id="street_address" name="street_address" rows="3"></textarea>
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        <li>
                            <input wire:model="payment_method" class="hidden peer" id="hosting-small" required type="radio" value="bakong" />
            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mt-5 space-y-4">
                        <button type="submit" class="w-full inline-flex items-center justify-center bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 transform hover:scale-[1.02] shadow-lg hover:shadow-xl">
                        ...
                        <ul class="divide-y divide-gray-200 dark:divide-gray-700" role="list">
                            ...
                            <li class="py-3 sm:py-4" wire:key='{{ $ci["product_id"] }}'>
                                <div class="flex items-center">
                                    ...
                                    <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-gray-200">
