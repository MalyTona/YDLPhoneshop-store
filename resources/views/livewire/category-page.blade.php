  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="text-center mb-10">
      ...
      <p class="max-w-2xl mx-auto text-base text-gray-600 dark:text-gray-400">
        ស្វែងរកអ្វីដែលអ្នកត្រូវការបានយ៉ាងងាយស្រួល មិនថាជាទូរស័ព្ទមួយទឹកគុណភាពល្អ សេវាកម្មជួសជុល ឬគ្រឿង Accessories
        ផ្សេងៗ។
      </p>
    </div>
    ...
    <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6">
      ...
      <div class="p-4 md:p-5">
        ...
        <div class="ps-3">
          <svg class="flex-shrink-0 w-5 h-5 text-gray-600 dark:text-white" xmlns="http://www.w3.org/2000/svg"
