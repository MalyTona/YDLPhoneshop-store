  ...
  <section class="bg-gray-50 dark:bg-slate-900 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-12 grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-6">
        ...
        <a wire:navigate href="/products?selected_brands[0]={{ $brand->id}}" class="block bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-all duration-200 hover:shadow-lg brand-card" wire:key="{{ $brand->id }}">
