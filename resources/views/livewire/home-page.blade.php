<div>
  ...
  <section class="bg-gray-50 dark:bg-slate-900 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <a wire:navigate href="/products?selected_brands[0]={{ $brand->id}}"
        ...
        <img src="{{ Storage::url($brand->image) }}" alt="{{ $brand->name }} Logo"
  ...
  <section class="bg-white dark:bg-slate-900 py-12 sm:py-16 lg:py-20">
    ...
    <div class="max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <a wire:navigate
        class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-lg transition dark:bg-slate-800 dark:border-gray-700"
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="ps-3">
          <img src="https://cdn-icons-png.flaticon.com/512/130/130884.png" alt="Go to category"
