          ...
          <div class="w-full md:w-1/3">
            <div class="flex flex-col p-4 space-y-2 bg-gray-50 dark:bg-gray-700 rounded-md">
              <div class="flex items-center justify-between">
                ...
                <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ \Illuminate\Support\Number::currency($subtotal, 'USD') }}</p>
              </div>
              <div class="flex items-center justify-between">
                <p class="text-sm leading-4 text-gray-800 dark:text-gray-400">Shipping</p>
                <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ \Illuminate\Support\Number::currency($order->shipping_amount, 'USD') }}</p>
              </div>
              <div class="flex items-center justify-between">
                <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400">Total</p>
                <p class="text-base font-semibold leading-4 text-gray-600 dark:text-gray-400">{{ \Illuminate\Support\Number::currency($order->grand_total, 'USD') }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-8 px-4 mb-10 md:grid-cols-2">
          ...
          <div>
            ...
            <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
                <div class="mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-8 h-8 text-blue-600 dark:text-blue-400 bi bi-truck" viewBox="0 0 16 16">
                        <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5v-7zm1.294 7.456A1.999 1.999 0 0 1 4.732 11h5.536a2.01 2.01 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456zM12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12v4zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"></path>
                    </svg>
                </div>
                <div>
                    <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">{{ $order->shipping_method }}</p>
