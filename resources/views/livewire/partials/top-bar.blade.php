<div class="w-full bg-amber-600 dark:bg-amber-700 text-white text-xs sm:text-sm py-2">
    <div class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <!-- Left side - Shop Quote -->
            <div class="flex items-center justify-center sm:justify-start">
                <span class="font-medium text-center sm:text-left"> មានទទួល ជួសជុលទូរសព្ទ ដោះកូដដៃ បុកប្រូក្រាម អ៊ុតកញ្ចក់ថាច់.ល. 071 600 8881</span>
            </div>

            <!-- Right side - Contact & Social -->
            <div class="flex items-center justify-center sm:justify-end gap-3 text-xs sm:text-sm">
                ...
                <div class="hidden sm:flex items-center gap-1">
                    ...
                    <span>ត្បូងឃ្មុំ</span>
                </div>

                <!-- Social Media -->
                <div class="flex items-center gap-2">
                    <!-- Facebook -->
                    <a href="https://web.facebook.com/love.cambodia.9440234" class="hover:text-amber-200 transition-colors duration-200" aria-label="Facebook">
                    ...
                    <!-- Instagram -->
                    <a href="#" class="hover:text-amber-200 transition-colors duration-200" aria-label="Instagram">
                        <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Telegram -->
                    <a href="https://t.me/Yoth_Dalen" class="hover:text-amber-200 transition-colors duration-200" aria-label="Telegram" target="_blank" rel="noopener">
                        <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24">
